...
if (
  ...
  throw new Error(
    "O Spring Initializr não retornou um projeto Gradle válido: build.gradle não encontrado."
  );
}
...
if (
  ...
  throw new Error(
    "O Spring Initializr não retornou o Gradle Wrapper esperado: gradlew não encontrado."
  );
}
